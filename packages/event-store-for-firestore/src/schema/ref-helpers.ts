...
export function getAccountEventCollectionForQueryRefFromParentRef(
  parent: DocumentReference<AccountDocumentForQuery>,
): CollectionReference<AccountEventDocumentForQuery> {
  return parent
    .collection("events")
...
export function getAccountEventDocumentForQueryRefFromParentRef(
  ...
  return getAccountEventCollectionForQueryRefFromParentRef(parent).doc(eventId);
}
